...
<div class="row">
<div class="col-md-12">
<h3><b><FONT size='50px'>User Records</font></b></h3> <hr />
<a href="admin.php"><button class="btn btn-warning">Back</button></a>
<a href="insert_ur.php"><button class="btn btn-warning">Add Record</button></a><hr />
...
<tbody>
<?php
$sql =mysqli_query($con, "call user_records()");
$cnt=1;
...
<td><?php echo htmlentities($result['Returned_Date_and_Time']);?></td>
</tr>
<?php
