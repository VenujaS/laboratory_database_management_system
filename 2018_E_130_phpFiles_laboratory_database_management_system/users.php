...
<div class="row">
<div class="col-md-12">
<h3><b><FONT size='50px'>Students Details</font></b></h3> <hr />
<a href="admin.php"><button class="btn btn-warning">Back</button></a>
<a href="insert_student.php"><button class="btn btn-warning">Add Student</button></a><hr />
...
<tbody>
<?php
$sql =mysqli_query($con, "call userDetails()");
$cnt=1;
